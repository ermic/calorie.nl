...
// Sta alleen veilige image-bronnen toe: app-relatieve paden of https://.
// Blokt javascript:, data:, http:// (mixed-content) en andere schemes —
// photoUrl kan via AI- of user-input gezet worden.
